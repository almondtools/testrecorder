		...
		class Bridged {
			...
			void onPrimitiveResultNoArgs() throws Exception {
				...
				assertThat(ByteCode.toString(insnlist)).containsExactly(
					...
					"LDC 0",
					"ANEWARRAY java/lang/Object",
					"INVOKESTATIC net/amygdalum/testrecorder/fakeio/bridge/BridgedFakeIO.callFake (Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;",
					"DUP",
					"GETSTATIC net/amygdalum/testrecorder/fakeio/bridge/BridgedFakeIO.NO_RESULT : Ljava/lang/Object;",
					"IF_ACMPEQ L0",
					"CHECKCAST java/lang/Boolean",
					"INVOKEVIRTUAL java/lang/Boolean.booleanValue ()Z",
					"IRETURN",
