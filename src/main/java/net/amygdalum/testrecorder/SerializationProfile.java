...
public interface SerializationProfile {
	 ...
	 * 
	 * {@link net.amygdalum.testrecorder.Fields} provides some default predicates to put into this list.
	 *  
	 ...
	 * (e.g if they are irrelevant or not easily serialized).
	 * 
	 * {@link net.amygdalum.testrecorder.Classes} provides some default predicates to put into this list.
	 *  
	 ...
	 * 
	 * {@link net.amygdalum.testrecorder.Fields} provides some default predicates to specify global variables/static fields.
	 *  
	 * @see Global
	 ...
	 * 
	 * {@link net.amygdalum.testrecorder.Methods} provides some default predicates to specify methods that provide input.
	 *  
	 * @see Input
