...
public class SerializedNullTest {
	...
	public void testGetType() throws Exception {
		SerializedNull value = new SerializedNull(String.class);
	...
	public void testEquals() throws Exception {
		assertThat(new SerializedNull(String.class), satisfiesDefaultEquality()
			.andEqualTo(new SerializedNull(String.class))
			.andNotEqualTo(new SerializedNull(Integer.class)));
	}
