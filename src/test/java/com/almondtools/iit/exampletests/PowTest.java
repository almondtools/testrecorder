...
import com.almondtools.iit.examples.Pow;
...
public class PowTest {
	...
	public void before() throws Exception {
		...
		instrumentor.register("com.almondtools.iit.examples.Pow");
	...
	public void after() throws Exception {
		testGenerator.writeTests(Paths.get("target/generated"), Pow.class);
	}
	

	@Test
	public void testSnapshotSize() throws Exception {
		Pow.main(new String[0]);
