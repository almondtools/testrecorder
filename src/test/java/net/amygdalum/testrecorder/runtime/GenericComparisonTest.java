...
public class GenericComparisonTest {
    ...
    public void testEqualsHashcode() throws Exception {
        ...
        Node node2 = new Node("name2");
        GenericComparison comparison = new GenericComparison("root", node1, node2);
        assertThat(comparison, satisfiesDefaultEquality()
    ...
    public void testToString() throws Exception {
        Node node1 = new Node("name1");
        Node node2 = new Node("name2");
        assertThat(new GenericComparison("root", node1, node2).toString(), WildcardStringMatcher.containsPattern("root*false"));
    }
