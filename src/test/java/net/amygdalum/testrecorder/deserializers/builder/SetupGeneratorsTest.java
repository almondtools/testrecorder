...
public class SetupGeneratorsTest {
    ...
    public void testVisitField() throws Exception {
        ...
        Computation result = setupCode.visitField(new SerializedField(ContainingList.class, "list", type, value), ctx);
    ...
    public void testVisitFieldWithCastNeeded() throws Exception {
        Computation result = setupCode.visitField(new SerializedField(Complex.class, "simple", Simple.class, values.object(Object.class, new Complex())), ctx);
    ...
    public void testVisitFieldWithHiddenTypeAndVisibleResult() throws Exception {
        ...
        Computation result = setupCode.visitField(new SerializedField(ContainingList.class, "list", parameterized(List.class, null, String.class), value), ctx);
    ...
    public void testVisitFieldWithHiddenTypeAndHiddenResult() throws Exception {
        ...
        Computation result = setupCode.visitField(new SerializedField(ContainingList.class, "list", parameterized(classOfHiddenList(), null, String.class), value), ctx);
    ...
    public void testVisitReferenceType() throws Exception {
        ...
        Computation result = setupCode.visitReferenceType(value, ctx);
    ...
    public void testVisitReferenceTypeRevisited() throws Exception {
        SerializedObject value = values.object(Dubble.class, new Dubble("Foo", "Bar"));
        setupCode.visitReferenceType(value, ctx);
    ...
    public void testVisitImmutableType() throws Exception {
        ...
        Computation result = setupCode.visitImmutableType(value, ctx);
    ...
    public void testVisitValueType() throws Exception {
        ...
        Computation result = setupCode.visitValueType(value, ctx);
