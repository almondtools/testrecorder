...
public class PathConfigurationLoaderTest {
	...
	class testLoad {
		@Test
		void common(TemporaryFolder folder) throws Exception {
		...
		@Test
		void withClassLoader(TemporaryFolder folder) throws Exception {
			folder.provideFile("net.amygdalum.testrecorder.profile.ConfigNoArgumentsNonExclusive",
				"net.amygdalum.testrecorder.profile.DefaultConfigNoArguments\nnet.amygdalum.testrecorder.profile.OtherConfigNoArguments".getBytes());
		...
		@Test
		void withFileNotFound(TemporaryFolder folder, @LogLevel("debug") ByteArrayOutputStream debug) throws Exception {
			folder.provideFile("net.amygdalum.testrecorder.profile.ConfigNoArgumentsNonExclusive",
				"net.amygdalum.testrecorder.profile.DefaultConfigNoArguments\nnet.amygdalum.testrecorder.profile.OtherConfigNoArguments".getBytes());
		...
		@ExtendWith(LoggerExtension.class)
		@Test
		void withIOException(TemporaryFolder folder, @LogLevel("error") ByteArrayOutputStream error) throws Exception {
			folder.provideFile("net.amygdalum.testrecorder.profile.ConfigNoArgumentsNonExclusive",
				"net.amygdalum.testrecorder.profile.DefaultConfigNoArguments\nnet.amygdalum.testrecorder.profile.OtherConfigNoArguments".getBytes());
